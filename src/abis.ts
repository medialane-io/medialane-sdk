...
// @deprecated Since v0.11.0 — use `IPCollectionABI` (full audited ABI) for new code.
// Kept for backward compatibility with consumers that only need list_user_collections + get_collection.
...
// ─── MIP-Collections-ERC721 (Audited v3) ─────────────────────────────────────
// Audited mainnet deployment 2026-05-14.
